                ...
                <div class="promotion" >
                    ...
                    <div id="saleoff" class="tabcontent active" style="display: block;">
                                    ...
                                    <li class="row panel">
                                        <div class="col-md-7">
                                            <div class="col-md-4 content">
                                                <a href="<?=env('URL_OUTSIDE', '').'/so/'.$item['alias'].'-'.$item['id'].'.html'?>"
                        ...
                        <div class="create-landingpage banner-update">
                            <form class="form-create landing-page frm_update" method="post" id="form_update" action="{{ route("microsites.add") }}">
                                ...
                                <div class="box">
                                    ...
                                    <div class="col-md-6 right-block">
                                        <h3 class="title-block">Giao diện trang khuyến mãi Sale off</h3>
                                        <div class="body-block">
                                            <ul class="list-radio layout">
                                                <li>
                                ...
                                <div class="box load-product-promotion LoadProduct">
                                    <h3 class="title-block TitleCreate">Thêm Danh sách sản phẩm khuyến mãi</h3>
                                    <h3 class="title-block TitleUpdate" style="display: none;">Cập nhật Danh sách sản phẩm khuyến mãi</h3>
                                    <h3 class="title-block TitleDisplay" style="display: none;">Danh sách sản phẩm khuyến mãi</h3>
                                    ...
                                    <div class="CreateLoad" style="display: none;">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Tên tầng sản phẩm</label>
                                            ...
                                            <div class="form-group fp_class">
                                                <label for="">Danh mục tầng</label>
                                                <div class="wrap_select fp_class">
                                                    {!! Form::select("fp_class",\App\Helpers\General::get_class_saleoff_options(), '', [
                                                    'id' => 'fp_class', 'class' => 'form-control', 'placeholder' => 'Chọn danh mục tầng']) !!}
                                                    <i class="fa fa-angle-down" aria-hidden="true"></i>
                                                </div>
                                                <label id="fp_class-error" class="error" for="fp_class" style="display: none;"></label>
                                            </div>
                                            <div class="form-group">
...
@section('after_scripts')
    ...
    <script type="text/javascript" src="/js/microsite-sale-off.js?v=<?=$version_js?>"></script>
