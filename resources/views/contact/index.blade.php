...
@section('content')
    <div class="col-md-">
        <section class="section section-article BannerAct">
            <h3 class="title-section">Liên hệ</h3>
            <div class="panel box-panel Panel">
                ...
                <div class="banner-update">
                    <form class="form-create" method="post" id="form_update" action="{{ route("contact.add") }}">
                        <div class="bussiness">
                            <div class="form-group ">

                                <div class="col-md-6">
                                    <div class="col-md-2 text-right">
                                        <label>Tên Côn ty</label>
                                    </div>
                                    <div class="col-md-10">
                                        <input type="text" id="company_name" class="form-control" placeholder="" readonly="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="col-md-2 text-right">
                                        <label>Mã sô thuế</label>
                                    </div>
                                    <div class="col-md-10">
                                        <input type="text" id="tax_code" class="form-control" placeholder="" readonly="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                 <div class="col-md-6">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" id="address" class="form-control" placeholder="" readonly="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group person">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-10">
                                    <input type="text" id="name" class="form-control" placeholder="" readonly="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="col-md-2 text-right">
                                ...
                                <div class="col-md-10">
                                    <input type="text" id="phone" class="form-control" placeholder="" readonly="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-10">
                                    <input type="text" id="email" class="form-control" placeholder="" readonly="">
                                </div>
                            </div>
                        </div>
