                            ...
                            <div class="pull-right time-display">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="wrap_select">
                                        {!! Form::select("select_time", $options_time, @$object['select_time'], ['id' => 'select_time', 'class' => 'form-control']) !!}
...
@foreach ($order_status as $index => $item)
                            <li class="row">
                              ...
                              <div class="col-md-7">
                                <div class="col-md-2">
                                    <span class="number">{{isset($day[$item['id']]) ? $day[$item['id']]['total']:0}}</span></div>
                                <div class="col-md-2">
                                    <span class="number">{{isset($week[$item['id']]) ? $week[$item['id']]['total']:0}}</span></div>
                                <div class="col-md-3">
                                    <span class="number">{{isset($month[$item['id']]) ? $year[$item['id']]['total']:0}}</span></div>
                                <div class="col-md-2">
...
@endforeach
                    ...
                    <ul class="footer">
                      <li class="row">
                        ...
                        <div class="col-md-7">
                          <div class="col-md-2"><span class="number">{{array_sum( array_column($day, 'total') )}}</span></div>
                          <div class="col-md-2"><span class="number">{{array_sum( array_column($week, 'total') )}}</span></div>
                          <div class="col-md-3"><span class="number">{{array_sum( array_column($month, 'total') )}}</span></div>
                          <div class="col-md-2"><span class="number">{{array_sum( array_column($year, 'total') )}}</span></div>
                          <div class="col-md-3"><span class="number">{{array_sum( array_column($lastyear, 'total') )}}</span></div>
                        </div>
                      </li>
                      <li class=" row">
                        <div class="col-md-5">
...
@foreach ($product_comments as $item)
                                  <li class="item-commend">
                                    ...
                                    <div class="col-md-10">
                                      ...
                                      <?php $comment = json_decode($item['comment'],true); ?>
                                      <div class="wrap-commend">
                                         <p class="commend-detail">{{$comment['title']}}<br>{{$comment['comment']}}</p>
