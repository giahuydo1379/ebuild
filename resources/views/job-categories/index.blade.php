...
@section('content')
    <div class="col-md-">
        <section class="section section-news BannerAct">
            <h3 class="title-section">Danh mục tuyển dụng</h3>
            <div class="panel box-panel Panel">
                <div class="top">
                    <h3 class="title TitleCreate" @if ($objects['total']) style="display: none;" @endif>Tạo danh mục</h3>
                ...
                <div class="banner banner-display">
                    <div class="table-display">
                        <div class="header_table">
                            ...
                            <div class="col-md-7">
                                <div class="col-md-5">
                                    <span>Số lượng vị trí tuyển dụng </span>
                                </div>
                                <div class="col-md-5">
                        ...
                        @foreach($objects['data'] as $index => $item)
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="col-md-5">
                                        <span>Có <?=isset($counts[$item['id']]) ? $counts[$item['id']] : 0;?> vị trí</span>
                                    </div>
                                    <div class="col-md-5">
                ...
                <div class="banner-update">
                    <form class="form-create" method="post" id="form_update" action="{{ route("job-categories.add") }}">
        ...
        $(document).ready(function() {
            ...
            $('.delete-action').on('click', function () {
                ...
                confirm_delete("Bạn có muốn xóa, danh mục này không?", function () {
                    ajax_loading(true);
                    $.post('{{route('job-categories.delete')}}', {
                        id: $(obj).attr('data-id'),
                        _token: '{!! csrf_token() !!}'
                    }, function(data){
                        ajax_loading(false);
