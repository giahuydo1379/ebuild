        ...
        <section class="section section-article BannerAct">
            ...
            <div class="panel box-panel Panel">
                ...
                <div class="banner-update">
                    <form class="form-create" method="post" id="form_update" action="{{ route("order-status.add") }}">
                        <div class="col-md-2"></div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="col-md-2 text-right">
                                    <label>Mã trạng thái <span>*</span></label>
                                </div>
                                <div class="col-md-10">
                                    <input type="text" name="id" id="id" class="form-control" placeholder="Nhập mã trạng thái">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="order_status_name" id="order_status_name" class="form-control" placeholder="Nhập tên trạng thái">
                                    <label id="order_status_name-error" class="error" for="order_status_name" style="display: none;"></label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2 text-right">
        ...
        $(document).ready(function() {
            ...
            $('.delete-action').on('click', function () {
                ...
                confirm_delete("Bạn có chắc chắn muốn xóa?", function () {
                    ajax_loading(true);
                    $.post('{{route('order-status.delete')}}', {
                        id: $(obj).attr('data-id'),
                        _token: '{!! csrf_token() !!}'
                    }, function(data){
                        ajax_loading(false);
            ...
            $('.update-action').on('click', function () {
                ...
                $('#action').val('update');
                $('#form_update #order_status_name').val(item.order_status_name);
            ...
            $('#form_update').validate({
                ...
                messages: {
                    id: {
                        required: "Vui lòng nhập mã trạng thái đơn hàng",
                        remote: "Mã trạng thái đơn hàng đã được sử dụng. Vui lòng nhập mã trạng thái khác."
                    },
                    order_status_name: "Vui lòng nhập tên trạng thái đơn hàng",
                },
