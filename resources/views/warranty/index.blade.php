    ...
    <div class="col-md-">
        <section class="section section-banner">
            ...
            <div class="panel box-panel">
                <?php
                if (isset($settings['warranty_banner']) && $settings['warranty_banner']['value']) {
                    $image = $settings['warranty_banner']['value'];
                    $link = $settings['warranty_banner']['field'];
                } else {
                    $image = '';
                    $link = '';
                }
                ...
                <div class="banner-update">
                    <form id="form_warranty_banner_update" action="{{route('chain-store.setting-update')}}">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="hidden" value="warranty_banner" name="key">
        ...
        <section class="section section-infor-listsuper">
            <?php
            $description = isset($settings['warranty_description']) ? $settings['warranty_description']['value'] : '';
            ?>
                ...
                <div class="box-update">
                    <form id="form_warranty_description_update" action="{{route('chain-store.setting-update')}}">
                        <div class="update-content">
                            ...
                            <input type="hidden" name="key" value="warranty_description">
                        </div>
