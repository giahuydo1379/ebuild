...
<div class="col-md-">
    <div class="wrap_view view_product create_product">
        <div class="header">
            ...
            <a href="<?=$url?>"><i class="fa fa-reply" aria-hidden="true"></i>  Quay lại</a>
        </div>
    </div>
        ...
        <form action="" id="frm_step2">
            ...
            <div class="form-group">
                ...
                <select name="payment_method_id" id="payment_method_id" class="form-control">
                    ...
                    <option <?=isset($object) && $item['id']==$object['payment_method_id']?' selected':''?> value="<?=$item['id']?>"><?=$item['name']?></option>
                    @endforeach
                </select>
            </div>
            @endif
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $.each(data_step1,function(k,v){
                ...
                if(v.name == 'service_unit_name'){
                    $('.title_step').html(v.value);
                }
            });
            ...
            $('#frm_step2').validate({
                ...
                submitHandler: function(form) {
                    ...
                    data_step2 = $.merge(data, data_step1);
                    var tmp = {
                        "name":"payment_method",
                        "value":$('#payment_method_id').find(":selected").text()
                    };
                    data_step2.push(tmp);
                    localStorage.setItem($key_step2, JSON.stringify(data_step2));
