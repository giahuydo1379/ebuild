        ...
        $(function(){
            ...
            $('#frm_step2').validate({
                ...
                submitHandler: function(form) {
                    ...
                    freezers_data_step2 = $.merge(data, freezers_data_step1);
                    var tmp = {
                        "name":"payment_method",
                        "value":$('#payment_method_id').find(":selected").text()
                    };
                    freezers_data_step2.push(tmp);
                    localStorage.setItem("freezers_data_step2", JSON.stringify(freezers_data_step2));
