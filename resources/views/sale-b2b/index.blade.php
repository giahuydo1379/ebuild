...
@section('content')
    <div class="col-md-">
        <section class="section section-banner BannerAct">
            <h3 class="title-section">Bán hàng b2b</h3>
            <div class="panel box-panel sale-b2b-banner">
                <?php
                if (isset($settings['sale_b2b_banner']) && $settings['sale_b2b_banner']['value']) {
                    $image = $settings['sale_b2b_banner']['value'];
                    $link = $settings['sale_b2b_banner']['field'];
                } else {
                    $image = '';
                    $link = '';
                }
                ...
                <div class="banner-update">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" value="sale_b2b_banner" name="key">
        ...
        <section class="section section-infor-listsuper ActionList">
            ...
            <div class="panel box-panel sale-b2b-info">
                <?php
                $description = isset($settings['sale_b2b_description']) ? $settings['sale_b2b_description']['value'] : '';
                ?>
                <div class="top">
                ...
                <div class="box-update">
                    ...
                    <div class="action text-right">
                        <span class="cancel">Hủy bỏ</span>
                        <input type="hidden" name="key" value="sale_b2b_description">
                        <input type="hidden" name="_token" value="{!! csrf_token() !!}">
