                    ...
                    <div class="form_search_fast row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::select("service_id", ['' => ''] + $service_all, @$params['service_id'],
                    ...
                    <div class="header_table">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="center col-md-3">Tên đơn vị</div>
                                <div class=" col-md-4">Dịch vụ</div>
                    ...
                    <ul class="body_table panel-group" id="accordion5">
                        ...
                        <li class="row panel">
                            <div class="col-md-8">
                                ...
                                <div class="status col-md-4"><?=$item['service_name']?></div>
                                <div class=" col-md-4"><?=$item['description']?></div>
                            </div>
                            <div class="col-md-4">
                                <div class=" col-md-3"> <?=$item['price']?></div>
                                <div class=" col-md-3"> <?=$item['position']?></div>
                                <div class=" col-md-3">
                                    <div class="wrapper_">
