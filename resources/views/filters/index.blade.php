    ...
    <section class="table_supply table-category tb_filter">
        <div class="wrap-table table_filter filter_parent">
            <div class="header-panel">
                <h3 class="title_supplier">Danh mục filter</h3>
                <div class="wrap_link">
            ...
            <div class="table-supply products">
                <div class="header_table">
                    <div class="col-md-7">
                        ...
                        <div class="col-md-5">
                            <span>Danh mục Filter</span>
                        </div>
                        <div class="col-md-4">
                            <span>Loại Filter</span>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="col-md-3">
                ...
                <ul class="category_product">
                    <?php
                    $types = \App\Helpers\General::get_feature_type_options();
                    ?>
            @foreach($objects['data'] as $index => $item)
                    <li class="row">
                        <div class="col-md-7">
                            ...
                            <div class="col-md-5">
                                <a href="<?=route('filters.list', ['id' => $item['id']])?>"><?=$item['name_vi']?></a>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-md-4">
                                <a href="<?=route('filters.edit', ['id' => $item['id']])?>" class="tooltip">
