    ...
    <div class="col-md-">
        <section class="section section-banner">
            ...
            <div class="panel box-panel">
                <?php
                if (isset($settings['service_center_banner']) && $settings['service_center_banner']['value']) {
                    $image = $settings['service_center_banner']['value'];
                    $link = $settings['service_center_banner']['field'];
                } else {
                    $image = '';
                    $link = '';
                }
                ...
                <div class="banner-update">
                    <form id="form_service_center_banner_update" action="{{route('chain-store.setting-update')}}">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="hidden" value="service_center_banner" name="key">
        ...
        <section class="section section-infor-listsuper">
            <?php
            $description = isset($settings['service_center_description']) ? $settings['service_center_description']['value'] : '';
            ?>
                ...
                <div class="box-update">
                    <form id="form_service_center_description_update" action="{{route('chain-store.setting-update')}}">
                        <div class="update-content">
                            ...
                            <input type="hidden" name="key" value="service_center_description">
                        </div>
