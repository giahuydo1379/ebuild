...
@section('content')
    <div class="col-md-">
        <section class="section section-news BannerAct">
            <h3 class="title-section">Danh mục tin tức</h3>
            <div class="panel box-panel Panel">
                    ...
                    <div class="table-display">
                        ...
                        @foreach($objects['data'] as $index => $item)
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-5">
                                        <span>Có <?=isset($count[$item['id']]) ? $count[$item['id']] : 0;?> bài viết</span>
                                    </div>
                                    <div class="col-md-4">
                ...
                <div class="banner-update">
                    <form class="form-create" method="post" id="form_update" action="{{ route("news-categories.add") }}">
        ...
        $(document).ready(function() {
            ...
            $('.delete-action').on('click', function () {
                ...
                confirm_delete("Bạn có muốn xóa, danh mục này không?", function () {
                    ajax_loading(true);
                    $.post('{{route('news-categories.delete')}}', {
                        id: $(obj).attr('data-id'),
                        _token: '{!! csrf_token() !!}'
                    }, function(data){
                        ajax_loading(false);
