    ...
    <section class="section section-banner">
        ...
        <div class="panel box-panel">
            ...
            <div class="banner-update">
                <form id="form_banner_update" action="{{route('static-pages.update-image')}}">
                    <div class="col-md-9">
        ...
        <div class="panel box-panel introduction-sales">
            ...
            <div class="box-content box-display">
                <div class="descrip-content">
                    <label class="title-box">Nội dung</label>
            ...
            <div class="box-update">
                <form id="form_update_content" action="{{route('static-pages.update-content')}}">
...
?>
    <script type="text/javascript" src="/js/static-pages.js?v=<?=$js?>"></script>

    <script type="text/javascript">
        $(document).ready(function() {
            var obj = $('.item-sub.active');
            obj.closest('.panel-collapse').addClass('in');
            obj.closest('.item-menu.panel').addClass('active-menu');
        });
    </script>
@endsection