    ...
    <div class="col-md-">
        <section class="section section-banner">
            ...
            <div class="panel box-panel">
                <?php
                if (isset($settings['fujiyama_shopping_guide_banner']) && $settings['fujiyama_shopping_guide_banner']['value']) {
                    $image = $settings['fujiyama_shopping_guide_banner']['value'];
                    $link = $settings['fujiyama_shopping_guide_banner']['field'];
                } else {
                    $image = '';
                    $link = '';
                }
                ...
                <div class="banner-update">
                    <form id="form_shopping_guide_banner_update" action="{{route('chain-store.setting-update')}}">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="hidden" value="fujiyama_shopping_guide_banner" name="key">
        ...
        <section class="section section-infor-listsuper">
            <?php
            if (isset($settings['fujiyama_shopping_guide_banner_2nd']) && $settings['fujiyama_shopping_guide_banner_2nd']['value']) {
                $image = $settings['fujiyama_shopping_guide_banner_2nd']['value'];
                $link = $settings['fujiyama_shopping_guide_banner_2nd']['field'];
            } else {
                $image = '';
                $link = '';
            }
            $description = isset($settings['fujiyama_shopping_guide_description']) ? $settings['fujiyama_shopping_guide_description']['value'] : '';
            ?>
                ...
                <div class="box-update">
                    <form id="form_shopping_guide_2nd_update" action="{{route('chain-store.setting-update-banner-description')}}">
                        <div class="update-banner">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="show_file">
                                    ...
                                    <input type="hidden" value="fujiyama_shopping_guide_banner_2nd" name="banner_key">
                                </div>
                        ...
                        <div class="update-content">
                            ...
                            <input type="hidden" name="description_key" value="fujiyama_shopping_guide_description">
                        </div>
