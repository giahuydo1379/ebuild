    ...
    <div class="col-md-" ng-app="myApp" ng-controller="myCtrl">
        <section class="section section-promotion">
            ...
            <div class="panel box-panel">
                ...
                <div class="promotion" >
                    <div class="tab">
                        <a href="{{route('fujiyama.banners.index')}}" class="tablinks home">Trang chủ</a>
                        {{--<a href="{{route('fujiyama.banners.type', ['type' => 'category'])}}" class="tablinks category">Ngành hàng</a>--}}
                        {{--<a href="{{route('fujiyama.banners.type', ['type' => 'detail'])}}" class="tablinks detail">Trang chi tiết sản phẩm</a>--}}
                        {{--<a href="{{route('fujiyama.banners.type', ['type' => 'special'])}}" class="tablinks special">Đặc biệt</a>--}}
                        {{--<a href="{{route('fujiyama.banners.type', ['type' => 'end-page'])}}" class="tablinks end-page">Cuối trang</a>--}}
                                    ...
                                    <li class="row">
                                        <div class="col-md-7">
                                            ...
                                            <div class="col-md-4 wrap-banner">
                                                <img src="{{$item['image_url'] . $item['image_location']}}" alt="Promotion">
                                            </div>
                            ...
                            <form class="form-create" method="post" id="form_update" action="{{ route("banners.add") }}">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="display-banner">
                                        ...
                                        <img class="preview-banner" src="/html/assets/images/banner-promotion.png" alt="Promotion" />
                                    </div>
                                </div>
                            </form>
                        </div>
