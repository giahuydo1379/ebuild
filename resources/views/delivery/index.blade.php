...
@section('content')
    <div class="col-md-">
        <section class="section section-banner">
            <h3 class="title-section">Banner giới thiệu</h3>
            <div class="panel box-panel">
                <?php
                if (isset($settings['delivery_banner']) && $settings['delivery_banner']['value']) {
                    $image = $settings['delivery_banner']['value'];
                    $link = $settings['delivery_banner']['field'];
                } else {
                    $image = '';
                    $link = '';
                }
                ...
                <div class="top">
                    ...
                    @if ($image)
                        <a class="pull-right delivery_banner_update">
                ...
                @if ($image)
                    <div class="banner banner-display">
                        <img id="delivery_banner" src="{{$image}}" alt="">
                    </div>
                @else
                    <div class="delivery_banner_add no-banner">
                ...
                <div class="banner-update">
                    <form id="form_delivery_banner_update" action="{{route('chain-store.setting-update')}}">
                        <div class="col-md-9">
                            <img class="preview-banner" src="{{$image}}" alt="">
                        </div>
                        <div class="col-md-3">
                            <ul class="wrap_btn">
                                <li>
                            ...
                            <input type="hidden" value="{{$image}}" name="value" id="image_url">
                            <input type="hidden" value="delivery_banner" name="key">
        ...
        <section class="section section-infor-listsuper">
            <?php
            $description = isset($settings['delivery_description']) ? $settings['delivery_description']['value'] : '';
            ?>
            <div class="panel box-panel delivery-description">
                <div class="top">
                    <h3 class="title">Thông tin giao hàng - lắp đặt</h3>
                    @if ($description)
                ...
                <div class="box-update">
                    <form id="form_delivery_description_update" action="{{route('chain-store.setting-update')}}">
                        <div class="update-content">
                            <label class="title-box">Mô tả ngắn</label>
                            <textarea class="value" name="value" placeholder="Nhập thông tin mô tả" rows="5" cols="20">{{$description}}</textarea>
                            <input type="hidden" name="field" value="">
                            <input type="hidden" name="key" value="delivery_description">
                        </div>
