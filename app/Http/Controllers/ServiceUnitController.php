...
class ServiceUnitController extends Controller
{
    public function __construct()
    {
        ...
        $this->data['controllerName'] = 'services-units';
        $this->data['title'] = 'đơn vị dịch vụ';
    ...
    public function index(Request $request){
        $params         = $request->all();
        $objects        = ServicesUnits::getData($params);        
    ...
    public function edit(Request $request, $id){
        ...
        $object    = ServicesUnits::find($id)->toArray();
        $service_all    = $this->serviceController->get_list_category();
        
        $this->data['data'] = $object;
        $this->data['service_all'] = array_pluck($service_all,'name','id');
        
        $this->data['audits'] = \App\Models\Audits::getAudits(['App\Models\ServicesUnits'], $id);
        $this->data['id']   = $id;
    ...
    public function store(Request $request){
        ...
        if($id){
            ...
            $data_products = \App\Helpers\General::get_data_fillable(new ServicesUnits(), $data);

            $object = ServicesUnits::find($id);
    ...
    public function change_status(Request $request){
        ...
        $rs = 0;
        foreach ($product_ids as $product_id) {
            $object = ServicesUnits::find($product_id);
            if ($object) {
                $object->update([
                    'status' => $data['status'],
