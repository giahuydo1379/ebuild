...
class FreezersController extends Controller
{
    public function __construct()
    {
        ...
        $this->data['controllerName'] = 'freezer';
        $this->data['title'] = 'Loại máy lạnh';
    }     

    
    public function index(Request $request){
        $params         = $request->all();
        $objects        = Freezer::getData($params);
    ...
    public function edit(Request $request, $id){
        ...
        $object    = Freezer::find($id)->toArray();
    ...
    public function store(Request $request){
        ...
        if($id){
            ...
            $data_products = \App\Helpers\General::get_data_fillable(new Freezer(), $data);

            $object = Freezer::find($id);
    ...
    public function change_status(Request $request){
        ...
        foreach ($product_ids as $product_id) {
            $object = Freezer::find($product_id);
            if ($object) {
                $object->update([
                    'status' => $data['status'],
