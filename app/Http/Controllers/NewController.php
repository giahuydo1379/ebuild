...
class NewController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $objects = \App\Models\News::select('*');
//        $objects->where('status', 13);
        ...
        $categories = \App\Models\NewsCategories::select('id', 'name')
                    ->where('status', 1)
    ...
    public function store(Request $request)
    {
        ...
        if ($id) {
            $rules['alias'] = 'required|unique:news,alias,'.$id;
        }
        ...
        if (isset($data['id']) && $data['id']) {
            ...
            $data = \App\Helpers\General::get_data_fillable(new \App\Models\News(), $data);

            $rs = \App\Models\News::where('id', $id)
                ->update($data);
        ...
        $rs = \App\Models\News::create($data);
    ...
    public function destroy(Request $request)
    {
        ...
        if ($id) {
            \App\Models\News::find($id)->delete();
